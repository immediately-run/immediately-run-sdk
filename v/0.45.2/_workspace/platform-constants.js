...
var require_appRoot = __commonJS({
  "node_modules/@immediately-run/platform-constants/dist/appRoot.js"(exports) {
    ...
    exports.underAppRoot = underAppRoot;
    exports.stripAppRoot = stripAppRoot;
    exports.metadataKeyFor = metadataKeyFor;
    exports.APP_ROOT = "/app";
    function underAppRoot(repoRelativePath) {
    ...
    function metadataKeyFor(repoRelativePath) {
...
var require_frontmatter = __commonJS({
  "node_modules/@immediately-run/platform-constants/dist/frontmatter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isFrontmatterEnvelope = isFrontmatterEnvelope;
    exports.isJsonSerializable = isJsonSerializable;
    function isFrontmatterEnvelope(value) {
      return typeof value === "object" && value !== null && !Array.isArray(value);
    }
    function isJsonSerializable(value, seen = /* @__PURE__ */ new Set()) {
      if (value === null)
        return true;
      switch (typeof value) {
        case "string":
      ...
      seen.add(value);
      const ok = Array.isArray(value) ? value.every((v) => isJsonSerializable(v, seen)) : Object.values(value).every((v) => isJsonSerializable(v, seen));
      seen.delete(value);
      return ok;
    }
  }
...
var require_mdxMetadata = __commonJS({
  "node_modules/@immediately-run/platform-constants/dist/mdxMetadata.js"(exports) {
    ...
    exports.validateMdxMetadataSidecar = validateMdxMetadataSidecar;
    exports.parseMdxMetadataSidecar = parseMdxMetadataSidecar;
    ...
    function validateMdxMetadataSidecar(raw) {
    ...
    function parseMdxMetadataSidecar(text) {
      let parsed;
      try {
...
var require_dist = __commonJS({
  "node_modules/@immediately-run/platform-constants/dist/index.js"(exports) {
    ...
    exports.isUnderSidecar = isUnderSidecar;
...
var inline_platform_constants_exports = {};
__reExport(inline_platform_constants_exports, __toESM(require_dist()));
