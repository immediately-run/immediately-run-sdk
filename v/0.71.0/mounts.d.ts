import { Invite } from './generated/spaces.js';
export { GrantRecord, Member, ResolvedUser, Role, SpaceInfo, acceptInvite, declineInvite, getSpaceMembers, inviteToSpace, listAllSpaces, listGrants, listMyInvites, listPendingInvites, listSpaces, lookupUser, revokeGrant, revokeInvite, setSpaceRole, unshareSpace } from './generated/spaces.js';
import { FileCap } from './tasks.js';
import { BundleLayout } from '@immediately-run/mdx-plugins';
export { BundleLayout } from '@immediately-run/mdx-plugins';
 ...
 */
declare const openLocalStore: () => Promise<SandboxMount>;
...
export { Invite, type MountQuery, type MountRemoveReason, type MountRule, type RemovedMount, type SandboxMount, type SandboxMountBundle, type SessionMount, type SpaceError, awaitMatchingMount, createSpace, findMount, getAppMountPath, getInvites, getMounts, getSessionMounts, importSettingsFromParent, listSettingsApps, makeContentRef, mount, mountSpace, onInvitesChange, onMountsChange, onSessionMountsChange, openLocalStore, openSettings, openSettingsOf, requestMount, requestSpace, resolveContentRef, resolveContentRefs, unmountSpace, useInvites, useMounts, useSessionMounts, waitForMount };
