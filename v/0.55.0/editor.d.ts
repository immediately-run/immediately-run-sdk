 ...
 */
declare const openInEditor: (path: string, selection?: EditorSelection) => Promise<void>;
/**
...
export { type EditTarget, type EditorOpenError, type EditorSelection, type EditorSessionError, type EditorWriteError, type RequestEditError, closeFile, createFile, createFolder, deleteEntry, openInEditor, renameEntry, requestEdit, setActiveFile, uploadFile };
